 ...
 *
 * Unlike [DecisionExpression], this does not represent Gurobi variables.  It is evaluated during
...
class VectorExpression internal constructor(private val expression: RuntimeExpression<DoubleArray>) {
    ...
    operator fun minus(other: VectorExpression): VectorExpression = VectorExpression { runtime ->
